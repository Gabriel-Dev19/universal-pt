      ...
      <div class="container px-xs-0">
        ...
        <div class="position-relative bg-roxo-escuro border shadow bg-azul-caixa-cidade mt-30 overflow-hidden col-12 d-flex row mx-auto pr-0 pt-1 pb-30 pl-65">
          ...
          <a class="d-flex col-12 mt-4 px-0 py-0 text-preto-cidades fs-sm-18 fw-600 btn align-items-center" @click.prevent="Aveiro">
            <ion-icon class="fs-20 text-vermelho mr-2" name="navigate-circle-outline" /> Aveiro
          </a>
          <a class="d-flex col-12 mt-4 px-0 py-0 text-preto-cidades fs-sm-18 fw-600 btn align-items-center" @click.prevent="Agueda">
            <ion-icon class="fs-20 text-vermelho mr-2" name="navigate-circle-outline" /> Águeda
          </a>
        </div>
      </div>
    </section>
      ...
      <div class="container px-xs-0">
        ...
        <div class="position-relative bg-roxo-escuro border shadow bg-azul-caixa-cidade mt-30 overflow-hidden col-12 d-flex row mx-auto pr-0 pt-1 pb-30 pl-65">
          ...
          <a class="d-flex col-12 mt-4 px-0 py-0 text-preto-cidades fs-sm-18 fw-600 btn align-items-center" @click.prevent="OliveiraDeAzemeis">
            <ion-icon class="fs-20 text-vermelho mr-2" name="navigate-circle-outline" /> Oliveira de Azeméis
          </a>
...
export default {
  layout: 'layoutSobre',
  head: {
    title: 'Detective privado em Aveiro - Universal Detectives Privados'
  },
  methods: {
    Aveiro () {
