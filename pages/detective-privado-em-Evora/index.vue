<template>
  <div>
    <Home
      ...
      hash-btn="cidades"
      title-principal="Detective privado no distrito de Évora"
    />
    <div class="container container-text-cidades row mx-auto justify-content-center">
      <div class="col-10 px-0">
        <h2 class="azul mb-3 text-center">
          Encontre um detective em Évora
        </h2>
        <p class="text-center">
          A UNIVERSAL DETECTIVES está em Évora e desejamos ajudar você a solucionar suas dúvidas. Com <span class="P-negrito">mais de 20 anos de experiência</span> e centenas de casos solucionados, atuamos em todo o território nacional e países do Mercosul. Nosso principal objetivo é esclarecer as dúvidas de nossos clientes, antes de tomar uma atitude diante a situação em que você está vivenciando, é importante que você tenha plena certeza de tudo que está acontecendo.
        </p>
        <p class="text-center">
      ...
      <div class="container px-xs-0">
        ...
        <div class="position-relative bg-roxo-escuro border shadow bg-azul-caixa-cidade mt-30 overflow-hidden col-12 d-flex row mx-auto pr-0 pt-1 pb-30 pl-65">
          ...
          <a class="d-flex col-12 mt-4 px-0 py-0 text-preto-cidades fs-sm-18 fw-600 btn align-items-center" @click.prevent="Evora">
            <ion-icon class="fs-20 text-vermelho mr-2" name="navigate-circle-outline" /> Évora
          </a>
        </div>
      </div>
    </section>
...
export default {
  layout: 'layoutSobre',
  head: {
    title: 'Detective privado em Évora - Universal Detectives Privados'
  },
  methods: {
    Evora () {
