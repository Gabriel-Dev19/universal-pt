...
export default {
  layout: 'layoutSobre',
  head: {
    title: 'Detetive particular em Goiás - Universal Detetives Particulares'
  },
  methods: {
    Goiania () {
