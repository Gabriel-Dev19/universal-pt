...
export default {
  layout: 'layoutSobre',
  head: {
    title: 'Detetive particular em Minas Gerais - Universal Detetives Particulares'
  },
  methods: {
    BeloHorizonte () {
