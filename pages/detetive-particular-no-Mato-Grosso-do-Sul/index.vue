...
export default {
  layout: 'layoutSobre',
  head: {
    title: 'Detetive particular no Mato Grosso do Sul - Universal Detetives Particulares'
  },
  methods: {
    CampoGrande () {
