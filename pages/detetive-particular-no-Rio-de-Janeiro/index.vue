...
export default {
  layout: 'layoutSobre',
  head: {
    title: 'Detetive particular no Rio de Janeiro - Universal Detetives Particulares'
  },
  methods: {
    RioDeJaneiro () {
